...
const NovoEmpreendimentoScreen: React.FC<Props> = ({ onSave, onCancel, logoUrl }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.nome || !formData.responsavel) {
      alert('Preencha o nome do empreendimento e o responsável.');
      return;
    }
    onSave(formData);
  };
    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-lg mx-auto pb-32 px-1">
      ...
      <form onSubmit={handleSubmit} className="bg-slate-900 p-6 rounded-3xl border border-slate-800 space-y-5 shadow-2xl">
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-[8px] font-black text-slate-500 uppercase tracking-widest mb-1.5">Responsável</label>
            <div className="relative">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-[8px] font-black text-slate-500 uppercase tracking-widest mb-1.5">Telefone</label>
              <input 
                type="text" 
            ...
            <div>
              <label className="block text-[8px] font-black text-slate-500 uppercase tracking-widest mb-1.5">Email</label>
              <input 
                type="email" 
